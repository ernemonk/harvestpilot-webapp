...
export default function ModuleOverview({ module }) {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: [_jsx(StatusCard, { icon: "\uD83D\uDFE2", title: "System Status", value: module.status === 'online' ? 'Online' : 'Offline', subtitle: `Last check-in: ${formatLastSeen(module.lastHeartbeat)}`, status: module.status }), _jsx(StatusCard, { icon: "\uD83C\uDF10", title: "Network", value: module.ipAddress || 'Not Available', subtitle: `MAC: ${module.macAddress || 'Unknown'}` }), _jsx(StatusCard, { icon: "\u2699\uFE0F", title: "OS", value: module.os || 'Unknown', subtitle: "Linux-based system" })] }), _jsxs("div", { className: "bg-white rounded-xl border border-gray-200 overflow-hidden", children: [_jsxs("button", { onClick: () => setShowDeviceInfo(!showDeviceInfo), className: "w-full px-6 py-4 flex items-center justify-between hover:bg-gray-50 transition-colors", children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900", children: "Device Information" }), _jsx("svg", { className: `w-5 h-5 text-gray-500 transition-transform ${showDeviceInfo ? 'rotate-180' : ''}`, fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M19 14l-7 7m0 0l-7-7m7 7V3" }) })] }), showDeviceInfo && (_jsx("div", { className: "border-t border-gray-200 p-6", children: _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: [_jsxs("div", { className: "space-y-4", children: [_jsx("h4", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wide", children: "Identifiers" }), _jsx(InfoItem, { label: "Device ID", value: module.deviceId }), _jsx(InfoItem, { label: "Device Name", value: module.deviceName || '--' }), _jsx(InfoItem, { label: "Hardware Serial", value: module.hardwareSerial || '--' })] }), _jsxs("div", { className: "space-y-4", children: [_jsx("h4", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wide", children: "Network" }), _jsx(InfoItem, { label: "IP Address", value: module.ipAddress || 'Not Available' }), _jsx(InfoItem, { label: "MAC Address", value: module.macAddress || 'Unknown' }), _jsx(InfoItem, { label: "Hostname", value: module.hostname || '--' })] }), _jsxs("div", { className: "space-y-4", children: [_jsx("h4", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wide", children: "System" }), _jsx(InfoItem, { label: "Platform", value: module.platform || '--' }), _jsx(InfoItem, { label: "OS", value: module.os || '--' }), _jsx(InfoItem, { label: "Status", value: _jsx("span", { className: `px-2 py-1 rounded-full text-xs font-medium ${module.status === 'online'
                                                    ? 'bg-green-100 text-green-700'
                                                    : 'bg-gray-100 text-gray-700'}`, children: module.status === 'online' ? '🟢 Online' : '🔴 Offline' }) })] }), _jsxs("div", { className: "space-y-4", children: [_jsx("h4", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wide", children: "Timestamps" }), _jsx(InfoItem, { label: "Last Heartbeat", value: formatLastSeen(module.lastHeartbeat) }), _jsx(InfoItem, { label: "Last Sync", value: formatLastSeen(module.lastSyncAt) }), _jsx(InfoItem, { label: "Initialized", value: module.initializedAt ? new Date(module.initializedAt).toLocaleDateString() : '--' })] })] }) }))] }), _jsxs("div", { className: "bg-white rounded-xl border border-gray-200 p-6", children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-4", children: "Quick Actions" }), _jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3", children: [_jsx(QuickActionButton, { icon: "\uD83D\uDCA7", label: "Start Pump", sublabel: "30 seconds", onClick: () => handleQuickAction('pump_start'), loading: actionLoading === 'pump_start', disabled: module.status !== 'online' }), _jsx(QuickActionButton, { icon: "\uD83D\uDED1", label: "Stop Pump", onClick: () => handleQuickAction('pump_stop'), loading: actionLoading === 'pump_stop', disabled: module.status !== 'online', variant: "secondary" }), _jsx(QuickActionButton, { icon: "\uD83D\uDCA1", label: "Lights On", onClick: () => handleQuickAction('lights_on'), loading: actionLoading === 'lights_on', disabled: module.status !== 'online' }), _jsx(QuickActionButton, { icon: "\uD83C\uDF19", label: "Lights Off", onClick: () => handleQuickAction('lights_off'), loading: actionLoading === 'lights_off', disabled: module.status !== 'online', variant: "secondary" })] })] }), deviceState?.currentReading && (_jsxs("div", { className: "bg-white rounded-xl border border-gray-200 p-6", children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-6", children: "Current Conditions" }), _jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-6", children: [_jsx(MetricCard, { icon: "\uD83C\uDF21\uFE0F", label: "Temperature", value: deviceState.currentReading.temperature, unit: "\u00B0F", trend: "stable" }), _jsx(MetricCard, { icon: "\uD83D\uDCA7", label: "Humidity", value: deviceState.currentReading.humidity, unit: "%", trend: "up" }), _jsx(MetricCard, { icon: "\uD83C\uDF31", label: "Soil Moisture", value: deviceState.currentReading.soilMoisture, unit: "%", trend: "stable" }), _jsx(MetricCard, { icon: "\uD83D\uDCA6", label: "Water Level", value: deviceState.currentReading.waterLevel, unit: "%", trend: "down" })] })] })), deviceState && (_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [_jsx(AutopilotCard, { enabled: deviceState.autopilotMode === 'on', lastIrrigation: deviceState.lastIrrigationAt, nextIrrigation: deviceState.nextIrrigationAt, lightsOn: deviceState.lightsOn }), _jsx(CropInfoCard, { cropConfig: deviceState.cropConfig })] }))] }));
}
// ============================================
// SUB-COMPONENTS
// ============================================
...
function InfoItem({ label, value }) {
    return (_jsxs("div", { children: [_jsx("p", { className: "text-xs text-gray-500 mb-1", children: label }), _jsx("p", { className: "text-sm font-medium text-gray-900 break-all", children: typeof value === 'string' ? value : value })] }));
}
